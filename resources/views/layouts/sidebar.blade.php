...
<body class="all_content">
  <div class="d-flex">
    <div class="sidebar">
      @section('sidebar')
      <p><img src="{{asset('image\baseline_home_white_24dp.png')}}"><a href="{{ route('top.show') }}">トップ</a></p>
      ...
      <p><img src="{{asset('image\baseline_supervisor_account_white_24dp.png')}}"><a href="{{ route('user.show') }}">ユーザー検索</a></p>
      @show
    </div>
